      ...
      <div className="analysis-page">
        ...
        <div className="summary-grid" style={{
          ...
          <div className="summary-card" style={{
            ...
            <h4 style={{ color: '#6b7280', fontSize: '12px', fontWeight: '600', marginBottom: '15px' }}>
              TOP TRIGGER
            </h4>
            <div style={{ fontSize: '32px', color: '#3b82f6', fontWeight: 'bold', marginBottom: '10px' }}>
              {topTriggerName}
            </div>
            <p style={{ color: '#9ca3af', fontSize: '14px' }}>
              r = {data.correlations.topTriggerValue}
            </p>
          </div>
          ...
          <div className="summary-card" style={{
            ...
            <div style={{ fontSize: '32px', color: '#f97316', fontWeight: 'bold', marginBottom: '10px' }}>
              7.0
            </div>
            <p style={{ color: '#9ca3af', fontSize: '14px' }}>
              Pollen Index Threshold
            </p>
          </div>
          ...
          <div className="summary-card" style={{
            ...
            <div style={{ fontSize: '32px', color: '#10b981', fontWeight: 'bold', marginBottom: '10px' }}>
              {data.daysLogged}
            </div>
            <p style={{ color: '#9ca3af', fontSize: '14px' }}>
              Days of logged data
